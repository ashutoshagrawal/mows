...
//    	    	break;
    ...
    function decodeMessage(input) {
    	...
    	switch(type) {
    	    ...
    	    case MESSAGE_TYPE.PUBLISH:
                ...
                var message = new Message(input.subarray(pos));
   ...
   ClientImpl.prototype.getTraceLog = function () {
    ...
    ClientImpl.prototype._doConnect = function (host, port) {
        ...
        this.socket = new WebSocket(wsurl, 'mqttv3.1', {origin:'http://111.93.235.84',protocol:'mqttv3.1'});
        //this.socket.binaryType = 'arraybuffer';
        this.socket.on('open',scope(this._on_socket_open, this));
        this.socket.on('message',scope(this._on_socket_message, this));
        this.socket.on('error',scope(this._on_socket_error, this));
        this.socket.on('close',scope(this._on_socket_close, this));

        this.sendPinger = new Pinger(this, this, this.connectOptions.keepAliveInterval);
        this.receivePinger = new Pinger(this, this, this.connectOptions.keepAliveInterval);

        this._connectTimeout = new Timeout(this, this, this.connectOptions.timeout, this._disconnected,  [ERROR.CONNECT_TIMEOUT.code, format(ERROR.CONNECT_TIMEOUT)]);
    };
    ...
    ClientImpl.prototype._on_socket_message = function (event) {
        this._trace("Client._on_socket_message", event);

        // Reset the receive ping timer, we now have evidence the server is alive.
        this.receivePinger.reset();
        var byteArray = new Uint8Array(event);
        try {
